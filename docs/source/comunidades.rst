...
Esta ubicado en internet y en el se centralizan tanto la monitorización como el contro de todos los elementos que componen el Internet de la Energía (IoE). A continuación se describen los elementos que componen este servidor:
...
**Logica de proceso** Cuando es necesario hacer cálculos de forma intensiva estos se dedarrollan en `Python <http://www.python.org/>`_
...
**Los centros de control** Estan pensado para centralizar todas las medidas de una comunidad energética y para, a través de las VPN, poder controlar todos los elementos de la comunidad.
