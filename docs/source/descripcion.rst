...
Se facilita la integración con otros sistemas informáticos externos. El **acceso a la plataforma desde otras aplicaciones**, ya sean desde ayuntamientos u de otras entidades, se hace a través de servicios web.
